...
// Styled Components
const FeaturedTrendsContainer = styled.div`
	max-height: 100%;
  text-align: center;
	.featured-header {
		font-size: 1.7rem;
    ...
    ${props => props.setting === 'light' ?  'text-shadow: 1px 1px 5px var(--color-pink-50)' : 'text-shadow: 1px 1px 5px var(--color-white-100)'};
	}
`;
